...
const HeroSection = () => {
    ...
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
       <img src={assets.marvelLogo} alt="marval logo" className='max-h-11 lg:h-11 mt-20' /> 
        
        <h1 className='text-5xl md:text-[70px] md:leading18 font-semibold max-w-110'>Guardians <br /> of the Galaxy</h1>
